...
Aktuell sind eingebettete Systeme in den unterschiedlichsten Anwendungsgebieten zu finden, so zum Beispiel in: Autos, Schienenfahrzeuge, Flugzeugen, in der Telekommunikation und bei der Fertigungsautomatisierung (S. 2)\cite{marwedelEingebetteteSystemeGrundlagen2021}.
