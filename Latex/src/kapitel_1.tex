...
Ein Raum zeichnet sich dadurch aus, dass man durch ihn hindurch navigieren kann.
...
Ein Beispiel für zweidimensionale Räume ist ein \ac{gui}; der Nutzer kann innerhalb dieser zwischen verschiedenen Tabs, Seiten oder Bereichen navigieren.
