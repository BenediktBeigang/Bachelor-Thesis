...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{1threshold.PNG}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{2threshold.PNG}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{ohneAcc.PNG}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{mitAcc.PNG}
