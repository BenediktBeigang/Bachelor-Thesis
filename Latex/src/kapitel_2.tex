...
%     \begin{tabular}{|l|l|l|}
%         \hline
%         ~                      & \parbox[c][1cm]{2.4cm}{WiFi        \\mit WebSocket} & \parbox[c][1cm]{2.8cm}{ESP-Now\\mit seriellem Port} \\ \hline                                                                  \\ \hline
%         Anzahl Mikrocontroller & 2                              & 3 \\ \hline
%         Daten-Pfad             & \parbox[c]{1.5cm}{2.4cm}{ESP32     \\->Router\\->Rollstuhl-Software}                            & test  \\ \hline
%         \parbox[c][1cm]{4cm}{"Hardcoding" von                       \\Verbindungsinformationen} & nicht notwendig & Ziel-MAC-Adressen \\ \hline
%         Vorteile               &                                &   \\ \hline
%     \end{tabular}
% \end{table}
...
\begin{table}[t]
    ...
    \begin{tabular}{|m{2.6cm}|m{4cm}|m{4cm}|}
        ...
        \parbox[c][3cm]{2.6cm}{Daten-Pfad}                    & \parbox[c]{3cm}{\shortstack{ESP32 \\$\downarrow$     \\Router\\$\downarrow$ \\Rollstuhl-Software}}                            & \parbox[c]{3cm}{\shortstack{ESP32\\$\downarrow$\\ ESP32\\$\downarrow$\\ Serieller-Port\\$\downarrow$\\ Rollstuhl-Software}}   \\ \hline
